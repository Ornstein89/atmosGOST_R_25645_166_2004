...
#include <iostream>
#define PARAMETERS_CHECK_ON
// Таблицы
double const a_low_table[8][7] = {
	{	120.0	,	120.0	,	120.0	,	120.0	,	120.0	,	120	,	120	},
	...
	{	-1.06953E-05	,	-0.000010753	,	-0.000011681	,	-1.25785E-05	,	-1.30227E-05	,	-1.24137E-05	,	-1.37072E-05	},
...
double const a_high_table[8][7] = {
	...
	{0.000227717,	-0.00016946,	-0.000328875,	-0.000420802,	-0.000228015,	-8.10546E-05,	-3.78851E-05},
	{-2.2543E-07,	3.27196E-07,	5.05918E-07,	5.73717E-07,	2.8487E-07,	1.15712E-07,	2.4808E-08},
...
double const b_high_table[6][7] = {
	...
	{0.000105824,	0.000141421,	0.000149015,	0.000142637,	0.000147851,	-3.69846E-05,	-0.000294882},
...
double const c_high_table[6][7] = {
	...
	{0.000217232,	0.000228061,	0.00014659,	-0.0000388,	-0.000262603,	-0.000321884,	-67.1937},
...
double const n_low_table[3][7] = {
	...
	{	-0.000004012	,	-0.000004012	,	-0.000004012	,	-0.000004012	,	-0.000004012	,	-0.000004012	,	-0.000004012	} };
...
double const e_low_table[10][7] = {
	{	120	,	120	,	120	,	120	,	120	,	120	,	120	},
	{	-0.731596	,	-0.752175	,	-0.570476	,	-0.949573	,	-0.967598	,	-1.02278	,	-0.757903	},
	{	0.00597345	,	0.00565925	,	0.00295802	,	0.00813121	,	0.00841991	,	0.00923633	,	0.00606068	},
	{	-5.82037E-06	,	1.8082E-06	,	1.68896E-05	,	-3.87813E-06	,	-0.000003585	,	-6.10128E-06	,	7.85296E-06	},
	{	6.84634E-08	,	3.33822E-08	,	-4.7475E-09	,	2.37694E-08	,	1.74801E-08	,	1.78211E-08	,	-9.74891E-09	},
	{	-9.50483E-11	,	-5.13965E-11	,	-1.72711E-11	,	-2.77469E-11	,	-1.96221E-11	,	-1.70073E-11	,	1.58377E-12	},
	{	-0.2067	,	-0.16971	,	-0.14671	,	-0.1315	,	-0.120916	,	-0.11363	,	-0.10444	},
	{	0.097533	,	0.07983	,	0.068808	,	0.061603	,	0.056538	,	0.053178	,	0.048551	},
	{	-0.011817	,	-0.0094393	,	-0.0079836	,	-0.0070866	,	-0.0064324	,	-0.0060436	,	-0.0053567	},
	{	0.0016145	,	0.0012622	,	0.0010535	,	0.00092813	,	0.00083723	,	0.00077982	,	0.00068809	} };

double const e_high_table[10][7] = {
	{600,	700,	780,	800,	800,	900,	760},
	{38.6199,	51.249,	68.4746,	58.422,	7.20188,	21.5948,	-88.4076},
	{-0.132147,	-0.167373,	-0.215659,	-0.166664,	0.0216109,	-0.0202239,	0.338518},
	{0.000175411,	0.000211832,	0.000262273,	0.000185486,	-6.52882E-05,	-1.72029E-05,	-0.000445581},
	{-1.02417E-07,	-1.18221E-07,	-1.40972E-07,	-9.12345E-08,	5.37077E-08,	2.83017E-08,	2.51729E-07},
	{2.21446E-11,	2.45055E-11,	2.82285E-11,	1.67118E-11,	-1.4095E-11,	-8.94486E-12,	-5.203E-11},
	{-0.2067,	-0.16971,	-0.14671,	-0.1315,	-0.120916,	-0.11363,	-0.10444},
	{0.097533,	0.07983,	0.068808,	0.061603,	0.056538,	0.053178,	0.048551},
	{-0.011817,	-0.0094393,	-0.0079836,	-0.0070866,	-0.0064324,	-0.0060436,	-0.0053567},
	{0.0016145,	0.0012622,	0.0010535,	0.00092813,	0.00083723,	0.00077982,	0.00068809} };
...
double atmosGOST_R_25645_166_2004(double const h_km, // altitude above Earth ellipsoid, km; 120<h_km<1500
	...
	double const Kp, // квазилогарифмически планетарный среднесуточный индекс геомагнитной активности, баллы
	double const F81, // averaged weighted F10.7 for previous 80 days + current day
	double const DoY, // day of year  // TODO день от начала года, параметр для временной реализации функции, затем должен быть заменён на Mjd_TT
	double const X[3], // x, y, z - гринвичские координаты точи пространства, км
	double t_s, // всемирное время, с
	double S_rad, // звёздное время в гринвическую полночь, рад
	double alpha_rad, // прямое восхождение Солнца, рад
	double delta_rad // склонение Солнца, рад
)
